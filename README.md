...
## Features
- **Input Sanitization**: Protects against prompt injection and ensures privacy.
- **Crisis Interception**: Real-time routing for immediate support when severe distress is detected.
- **Memoized Coping Strategies**: Daily mindfulness exercises cached for efficiency.
- **A11y Compliant UI**: Fully accessible interface for all students.
